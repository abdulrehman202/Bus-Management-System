...
<head>
	...
	<script src="../js/liveBookingsData.js"></script>
</head>
	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="book bus.php">Book Bus</a>
				</li>
				<li class="nav-item active">
					<a class="nav-link active" href="#">View Past Bookings<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
